...
export function SubscriptionBanner() {
  return (
    <div className="mx-4 my-5 bg-gradient-to-br from-emerald-700 via-emerald-600 to-teal-600 rounded p-5 relative overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            <button 
              className="bg-white text-emerald-700 font-semibold px-5 py-2.5 rounded flex items-center gap-2 hover:bg-emerald-50 transition-colors"
          ...
          <div className="w-24 h-24 rounded overflow-hidden shadow-xl ml-3 flex-shrink-0">
