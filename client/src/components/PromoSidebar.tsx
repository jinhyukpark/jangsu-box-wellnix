        ...
        <div className="flex-1 flex flex-col">
          <div className="bg-gradient-to-br from-emerald-600 via-emerald-700 to-teal-700 rounded-3xl p-6 mb-6 shadow-xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="w-full aspect-[4/3] rounded-2xl overflow-hidden mb-5 shadow-2xl bg-white/10">
                <img 
                  src={giftBoxImage} 
                  alt="장수 박스 선물세트"
              ...
              <div className="text-center">
                ...
                <button 
                  className="w-full bg-white text-emerald-700 font-bold py-4 rounded-2xl flex items-center justify-center gap-2 hover:bg-emerald-50 transition-all shadow-lg hover:shadow-xl"
          ...
          <div className="space-y-3 flex-1">
            ...
            <button className="w-full bg-emerald-50/80 hover:bg-emerald-100/80 rounded-2xl p-4 flex items-center gap-4 transition-all group">
              <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-sm">
            ...
            <button className="w-full bg-amber-50/80 hover:bg-amber-100/80 rounded-2xl p-4 flex items-center gap-4 transition-all group">
              <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-sm">
              ...
              <div className="w-12 h-12 bg-white rounded-lg p-1 shadow-sm">
                <div className="w-full h-full bg-stone-800 rounded grid grid-cols-4 grid-rows-4 gap-0.5 p-1">
